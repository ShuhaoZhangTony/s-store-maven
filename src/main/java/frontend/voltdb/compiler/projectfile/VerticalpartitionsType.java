...
package frontend.voltdb.compiler.projectfile;
...
public class VerticalpartitionsType {
    ...
    protected List<Verticalpartition> verticalpartition;
     ...
     * {@link Verticalpartition }
     * 
     * 
     */
    public List<Verticalpartition> getVerticalpartition() {
        if (verticalpartition == null) {
            verticalpartition = new ArrayList<Verticalpartition>();
        }
