...
package frontend.voltdb.messaging;
...
public class FastSerializer implements DataOutput {
    ...
    public DBBPool.BBContainer writeObjectForMessaging(FastSerializable object) throws IOException {
