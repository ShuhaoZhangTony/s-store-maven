...
public class ProcedureProfiler {
    ...
    // for profiling
    public static Level profilingLevel = Level.DISABLED;
    ...
    // Workload Trace
    public static WorkloadTrace workloadTrace;
    ...
    public static void initializeWorkloadTrace(Catalog catalog) {
        if (profilingLevel == Level.INTRUSIVE) {
            ...
            initializeWorkloadTrace(catalog, traceClass, tracePath, traceIgnore);
        }
    }
    
    public static void initializeWorkloadTrace(Catalog catalog, String traceClass, String tracePath, String traceIgnore) {
