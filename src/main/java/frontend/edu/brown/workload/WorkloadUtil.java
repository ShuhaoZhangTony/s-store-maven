...
import frontend.edu.brown.workload.filters.Filter.FilterResult;
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    throw new RuntimeException("dbError on line " + (line_ctr+1) + " of workload trace file '" + input_path.getAbsolutePath() + "'", ex);
                }
            } // WHILE
        }
