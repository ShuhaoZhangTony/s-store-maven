...
public class FeatureSet implements JSONSerializable {
    ...
    public void toJSON(JSONStringer stringer) throws JSONException {
        JSONUtil.fieldsToJSON(stringer, this, FeatureSet.class, Members.values());
    }

    @Override
    public void fromJSON(JSONObject json_object, Database catalog_db) throws JSONException {
        // First deserialize all of the fields except for TXN_VALUES
        Set<Members> fields = CollectionUtil.getAllExcluding(Members.values(), Members.TXN_VALUES);
