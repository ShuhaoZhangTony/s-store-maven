package frontend.edu.brown.hstore.specexec;
...
import frontend.edu.brown.hstore.BatchPlanner;
import frontend.edu.brown.hstore.BatchPlanner.BatchPlan;
...
public class PrefetchQueryPlanner {
    ...
    private final ThreadLocal<Map<Integer, BatchPlanner>> planners = new ThreadLocal<Map<Integer,BatchPlanner>>() {
        protected Map<Integer,BatchPlanner> initialValue() {
