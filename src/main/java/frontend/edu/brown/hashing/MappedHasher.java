 ...
 * 
 */
package frontend.edu.brown.hashing;
...
public class MappedHasher extends AbstractHasher {
    ...
    public void toJSON(JSONStringer stringer) throws JSONException {
        JSONUtil.fieldsToJSON(stringer, this, MappedHasher.class, Members.values());
    }
    
    @Override
    public void fromJSON(JSONObject json_object, Database catalog_db) throws JSONException {
        JSONUtil.fieldsFromJSON(json_object, catalog_db, this, MappedHasher.class, Members.values());
    }    
}
