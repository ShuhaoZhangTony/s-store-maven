...
import frontend.com.google_voltpatches.common.collect.Maps;
import frontend.com.google_voltpatches.common.primitives.Doubles;
 ...
 * an example round-trip using {@link Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     Maps#asConverter Maps.asConverter}. For example, use this to create
