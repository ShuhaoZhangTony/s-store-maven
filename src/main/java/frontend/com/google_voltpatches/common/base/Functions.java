...
import frontend.com.google_voltpatches.common.collect.BiMap;
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link BiMap BiMap} (or can be one), you
   * can use {@link Maps#asConverter Maps.asConverter} instead to get a
