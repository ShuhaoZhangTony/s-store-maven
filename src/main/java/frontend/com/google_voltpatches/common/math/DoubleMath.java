...
package frontend.com.google_voltpatches.common.math;

import static frontend.com.google_voltpatches.common.base.Preconditions.checkArgument;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.IMPLICIT_BIT;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.SIGNIFICAND_BITS;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.getSignificand;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.isFinite;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.isNormal;
import static frontend.com.google_voltpatches.common.math.DoubleUtils.scaleNormalize;
import static frontend.com.google_voltpatches.common.math.MathPreconditions.checkInRange;
import static frontend.com.google_voltpatches.common.math.MathPreconditions.checkNonNegative;
import static frontend.com.google_voltpatches.common.math.MathPreconditions.checkRoundingUnnecessary;
...
import frontend.com.google_voltpatches.common.annotations.VisibleForTesting;
import frontend.com.google_voltpatches.common.primitives.Booleans;
...
public final class DoubleMath {
   ...
   */
  @GwtIncompatible("#isMathematicalInteger, frontend.google_voltpatches.common.math.DoubleUtils")
  ...
  @GwtIncompatible("#roundIntermediate, java.lang.Math.getExponent, "
      + "frontend.google_voltpatches.common.math.DoubleUtils")
   ...
   * {@code k}.
   */
  @GwtIncompatible("frontend.google_voltpatches.common.math.DoubleUtils")
   ...
   *         infinite
   */
  @GwtIncompatible("java.lang.Math.getExponent, frontend.google_voltpatches.common.math.DoubleUtils")
