...
import static frontend.com.google_voltpatches.common.math.MathPreconditions.checkPositive;
...
import frontend.com.google_voltpatches.common.primitives.Longs;
 ...
 * {@code long} values, see {@link Longs}.
 *
    ...
    if (b >= -2 & b <= 2) {
      switch ((int) b) {
        ...
        case (-1):
          return ((k & 1) == 0) ? 1 : -1;
        case 2:
          MathPreconditions.checkNoOverflow(k < Long.SIZE - 1);
          return 1L << k;
        case (-2):
          MathPreconditions.checkNoOverflow(k < Long.SIZE);
          return ((k & 1) == 0) ? (1L << k) : (-1L << k);
        default:
          throw new AssertionError();
      }
